...
background=b1
###using pallete
img=image_import("pea_Bobwhite9.JPG")
...
im=measure_disease(pattern = "pea",
                   dir_original = "E:/individual_leaf",
                   dir_processed = "E:/individual_leaf/Images analysed2",
                   img_healthy = healthy,
                   img_symptoms = symptoms,
                   img_background = b1,
                   verbose = FALSE,
...
im$severity
class(im$severity)
write.csv(im$severity,"E:/individual_leaf/severity303.csv")
sad(im,n=10)    
sad(
  im,
  n=10,
